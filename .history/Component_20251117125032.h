...
/**
 * Default component constructor. Initializes values to 0.
 */
inline Component::Component() : x(0), y(0), width(0), height(0) {}

/**
 * Parameterized constructor with only coordinates.
...
/**
 * Parameterized constructor with dimensions and coordinates.
 * @param xCoord horizontal coordinate
 * @param yCoord vertical coordinate
...
/**
 * Default pixelAt function. Returns a blank character.
